                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="chart-card">
                        ...
                        <div class="chart-body">
                            <canvas id="vendasPorHoraChart" style="height: 400px;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                @foreach($vendedores_performance as $vendedor)
                                    <li class="styled-list-item">
                                        <div class="list-item-content">
                                            <div class="list-item-title fs-1">{{ $vendedor->vendedor }} | Notas {{ $vendedor->notas }} | Clientes {{ $vendedor->clientes }}</div>
                                        </div>
                        ...
                        <div class="chart-body">
                            <ul class="styled-list">
                                @foreach($top_clientes->take(5) as $cliente)
                                    <li class="styled-list-item">
                                        <div class="list-item-content">
                                            <div class="list-item-title fs-1">{{ Str::limit($cliente->cliente, 50) }} | Notas {{ $cliente->notas }}</div>
                                        </div>
