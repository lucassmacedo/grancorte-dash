...
>
    <div @class([
            'dropdown d-block' => $this->isBootstrap,
    ...
    >
        <button
            {{ 
                ...
                ->class([
                    'btn dropdown-toggle btn-sm btn-primary d-block d-md-inline mx-2' => $this->isBootstrap && $this->getBulkActionsButtonAttributes['default-styling'] ?? true,
