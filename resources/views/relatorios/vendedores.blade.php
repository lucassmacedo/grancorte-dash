            ...
            <form action="" method="get">
                <div class="row">
                    ...
                    <div class="form-group col-5 col-sm-2">
                        ...
                        {{ Form::select('cod_filial[]', \App\Models\Filial::listFiliais(), $data['cod_filial'],['multiple'=>'multiple','class' => 'form-control  ' . ($errors->has('cod_filial') ? ' is-invalid ' : ''),'data-control'=>'select2']) }}
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-start flex-column pt-0 pb-0">
                            ...
                            <div class="d-flex flex-column my-7">
                                <!--begin::Number-->
                                <span class="fw-semibold fs-2x text-gray-800 lh-1 ls-n2">{{ formatMoedaReal($dashboard_geral->sum('valor_liquido'),true) }}</span>
                                <!--end::Number-->
                ...
                <div class="col-sm-6 col-xl-3 mb-xl-5">
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-start flex-column pt-0 pb-0">
                            ...
                            <div class="d-flex flex-column my-7">
                                <!--begin::Number-->
                                <span class="fw-semibold fs-2x text-gray-800 lh-1 ls-n2">{{ $dashboard_geral->sum('notas') }}</span>
                                <!--end::Number-->
                ...
                @foreach($dashboard as $item)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('relatorios.vendas.clientes',['periodo'=> request()->input('periodo'),'cod_filial'=> request()->input('cod_filial'),'cod_vendedor'=> $item->cod_vendedor,]) }}">
                                {{$item->clientes}}
                            </a>
                        </td>
                        <td class="text-center">
                            <a href="{{ route('relatorios.vendas.produtos',['periodo'=> request()->input('periodo'),'cod_filial'=> request()->input('cod_filial'),'cod_vendedor'=> $item->cod_vendedor,]) }}">
                                {{$item->produtos}}
                            </a>
                        </td>
