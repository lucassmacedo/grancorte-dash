...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="/">
        ...
        @elseif($bodyAttribute === 'light-sidebar')
				<img alt="Logo" src="{{ image('logos/logo.png') }}" class="theme-light-show h-60px app-sidebar-logo-default" />
				<img alt="Logo" src="{{ image('logos/logo.png') }}" class="theme-dark-show h-60px app-sidebar-logo-default" />
		@endif
