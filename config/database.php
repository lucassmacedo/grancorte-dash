    ...
    */
    ...
    'connections' => [
        ...
        'protheus' => [
            'driver'         => 'sqlsrv',
            'url'            => env('DATABASE_URL'),
            'host'           => env('DB_PROTHEUS_SQLSRV_HOST', 'localhost'),
            'port'           => env('DB_PROTHEUS_SQLSRV_PORT', '1433'),
            'database'       => env('DB_PROTHEUS_SQLSRV_DATABASE', 'forge'),
            'username'       => env('DB_PROTHEUS_SQLSRV_USERNAME', 'forge'),
            'password'       => env('DB_PROTHEUS_SQLSRV_PASSWORD', ''),
            'charset'        => 'utf8',
            'prefix'         => '',
            'prefix_indexes' => true,
